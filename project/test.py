...
if __name__ == '__main__':
    ...
    puts(columns([(colored.red('Column 1')), col], [(colored.green('Column Two')), col],
                    [(colored.magenta('Column III')), col]))
    puts(columns(['hi there my name is kenneth and this is a columns', col], [lorem, col], ['kenneths', col]))